              ...
              {todayAppts.length === 0 ? (
                ...
                <div key={apt.appointmentId} className="px-6 py-4 flex items-center gap-4 hover:bg-cream-warm/50 dark:hover:bg-white/[0.02] transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-obsidian dark:text-gray-100 truncate">{apt.patientName}</p>
          ...
          <CardContent className="p-0">
            ...
            <div className="divide-y divide-gray-200 dark:divide-[#1e2737]">
              {consultations.length === 0 ? (
                ...
                <div key={c.consultId} className="px-6 py-4 hover:bg-cream-warm/50 dark:hover:bg-white/[0.02] transition-colors">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-obsidian dark:text-gray-100">{c.patientName}</p>
                      <p className="text-xs text-slate-muted dark:text-gray-500">{formatDateTime(c.consultTime)}</p>
                    </div>
                    <p className="text-xs text-silver dark:text-gray-500 truncate max-w-[200px]">{c.notes || 'No notes'}</p>
                  </div>
                </div>
              ))}
            </div>
