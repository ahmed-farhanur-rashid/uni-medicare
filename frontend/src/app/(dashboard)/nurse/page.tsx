        ...
        <CardContent className="p-0">
          ...
          <div className="divide-y divide-border/30">
            {consultations.length === 0 ? (
              ...
              <div key={c.consultId} className="px-6 py-4 flex items-center gap-4 hover:bg-cream-warm/50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-obsidian truncate">{c.patientName}</p>
