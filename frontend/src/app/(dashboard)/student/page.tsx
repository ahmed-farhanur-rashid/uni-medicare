    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="animate-fade-in-up stagger-3 opacity-0">
          <CardContent className="p-0">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-[#1e2737] flex items-center justify-between">
              <h2 className="font-semibold text-obsidian dark:text-gray-100 font-display">Upcoming Appointments</h2>
                ...
                upcomingAppointments.slice(0, 4).map((apt) => (
                  <div key={apt.appointmentId} className="px-6 py-4 flex items-center gap-4 hover:bg-cream-warm/50 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-obsidian dark:text-gray-100 truncate">
                        Dr. {apt.doctorName}
                      </p>
                      <p className="text-xs text-slate-muted dark:text-gray-500 truncate">
                        {apt.reason || 'General checkup'}
                      </p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-xs font-medium text-obsidian dark:text-gray-100">
        ...
        <Card className="animate-fade-in-up stagger-4 opacity-0">
          <CardContent className="p-0">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-[#1e2737] flex items-center justify-between">
              <h2 className="font-semibold text-obsidian dark:text-gray-100 font-display">Lab Results</h2>
            ...
            <div className="divide-y divide-gray-200">
              {labResults.length === 0 ? (
                ...
                labResults.slice(0, 4).map((lr) => (
                  <div key={lr.resultId} className="px-6 py-4 flex items-center gap-4 hover:bg-cream-warm/50 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-muted dark:text-gray-500">
        ...
        <Card className="animate-fade-in-up stagger-5 opacity-0">
          <CardContent className="p-0">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-[#1e2737] flex items-center justify-between">
              <h2 className="font-semibold text-obsidian dark:text-gray-100 font-display">Prescriptions</h2>
            ...
            <div className="divide-y divide-gray-200">
              {prescriptions.length === 0 ? (
                ...
                prescriptions.slice(0, 4).map((p) => (
                  <div key={p.prescriptionId} className="px-6 py-4 hover:bg-cream-warm/50 dark:hover:bg-white/[0.02] transition-colors">
                    <div className="flex items-start justify-between gap-4">
                      <div className="min-w-0">
                        <p className="text-sm font-medium text-obsidian dark:text-gray-100">
                          {p.diagnosis || 'General prescription'}
                        </p>
                        <p className="text-xs text-slate-muted dark:text-gray-500 mt-0.5">
                          {p.labTests.length} lab test{p.labTests.length !== 1 ? 's' : ''}
                        </p>
                      </div>
                      <p className="text-xs text-silver dark:text-gray-500 shrink-0">
        ...
        <Card className="animate-fade-in-up stagger-6 opacity-0">
          <CardContent className="p-0">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-[#1e2737] flex items-center justify-between">
              <h2 className="font-semibold text-obsidian dark:text-gray-100 font-display">Invoices</h2>
            ...
            <div className="divide-y divide-gray-200">
              {invoices.length === 0 ? (
                ...
                invoices.slice(0, 4).map((inv) => (
                  <div key={inv.invoiceId} className="px-6 py-4 flex items-center gap-4 hover:bg-cream-warm/50 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-sm font-semibold text-obsidian dark:text-gray-100">
