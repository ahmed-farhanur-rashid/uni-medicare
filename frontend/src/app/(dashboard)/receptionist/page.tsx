              ...
              {todayAppts.length === 0 ? (
                ...
                <div key={apt.appointmentId} className="px-6 py-4 flex items-center gap-4 hover:bg-cream-warm/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-obsidian truncate">{apt.patientName} — Dr. {apt.doctorName}</p>
        ...
        <Card className="animate-fade-in-up stagger-4 opacity-0">
          <CardContent className="p-0">
            ...
            <div className="p-6 grid grid-cols-2 gap-3">
              <button onClick={() => router.push('/receptionist/appointments')} className="p-4 rounded-xl border border-border hover:border-emerald hover:bg-emerald/5 transition-all text-center group">
                ...
                <p className="text-sm font-medium text-obsidian">Appointments</p>
              </button>
              <button onClick={() => router.push('/receptionist/billing')} className="p-4 rounded-xl border border-border hover:border-amber hover:bg-amber/5 transition-all text-center group">
                ...
                <p className="text-sm font-medium text-obsidian">Billing</p>
              </button>
            </div>
          </CardContent>
        </Card>
